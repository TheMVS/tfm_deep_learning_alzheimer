...
MODEL_TYPE = 'unet'  # Type of model for evaluate: full, convolutional, vgg16, mobile, mobilev2, resnet, unet, custom
...
CUSTOM_DIMENSION_LIST = [None,2]

USE_SKLEARN = False
SKLEARN_MODEL = 'linear_regression'
...
LAST_LAYERS = 0  # Last layers to remove from pretrained models
